...
// This file defines the necessary functions and structures to interact with the
// BMP280 sensor over I2C.
#ifndef BMP280_H
#define BMP280_H
...
static void bmp280_read_raw(int32_t *temp, int32_t *pressure);
static void bmp280_get_calib_params(struct bmp280_calib_param *params);
static void bmp280_reset(void);
static int32_t bmp280_convert_temp(int32_t temp,
                                   struct bmp280_calib_param *params);
static int32_t bmp280_convert_pressure(int32_t pressure, int32_t temp,
                                       struct bmp280_calib_param *params);

extern void get_temp_pres(float *temp, float *pres);
